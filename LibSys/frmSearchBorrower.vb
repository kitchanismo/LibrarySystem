Public Class frmSearchBorrower
    ...
    Private Sub Form1_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles pnheader.MouseMove, Label1.MouseMove
        ...
        End If
    End Sub
    Private Sub frmSearchBorrower_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FillMembers(lv)
        Me.TopMost = True
        frmIssuance.TopMost = False
    End Sub
    ...
    Private Sub lv_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lv.MouseClick
        With lv.SelectedItems(0)
            lblname.Text = .SubItems(1).Text
        End With
    End Sub

    Private Sub btnapply_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnapply.Click
        If lblname.Text = "..." Then
            frmMain.FlatAlertBox1.ShowControl(FlatAlertBox._Kind.Error, "Please Select Borrower!", 3000)
            Exit Sub
        End If
        frmIssuance.lblname.Text = lblname.Text
        _mod.frmfade(Me, 20)
        frmIssuance.TopMost = True
        Me.Close()
    End Sub
    ...
    Private Sub btnsearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsearch.Click
        If tbsearch.Text = "" Or tbsearch.Text = " Search ..." Then
            ...
            Exit Sub
        End If
        SearchMember(lv, tbsearch.Text.ToLower, lblresult)
